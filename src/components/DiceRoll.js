      ...
      <div className={`${isOpen ? 'open': 'close'}`}>
        <div className='subChoice'>
          <div className="tooltip tooltipDice">
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 100</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 20</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 12</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 10</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 8</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 6</span>
          </div>
          <div className="tooltip tooltipDice">
            <button
              className='subRoll'
            ...
            <span className={isMobile ? "tooltiptextMobile" : "tooltiptext"}>{i18next.t('dice')} 4</span>
          </div>
        </div>
      </div>
      <button
